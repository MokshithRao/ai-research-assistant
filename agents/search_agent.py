...
class SearchAgent:
    ...
    def __init__(
        self, max_retries: int = 3, backoff_factor: float = 2.0, timeout: int = 10
    ):
    ...
    def search_papers(self, query: str, max_results: int = 3) -> List[Dict]:
            ...
            return [
                {
                    ...
                    "summary": "Please enter a valid topic.",
                    "url": "#",
                }
            ]
        ...
        for attempt in range(1, self.max_retries + 1):
            try:
                ...
                logging.error(
                    f"Attempt {attempt}: Failed to fetch from arXiv API - {e}"
                )
                    ...
                    return [
                        {
                            ...
                            "summary": f"Failed to connect to arXiv after {self.max_retries} attempts. Please try again later.",
                            "url": "#",
                        }
                    ]
